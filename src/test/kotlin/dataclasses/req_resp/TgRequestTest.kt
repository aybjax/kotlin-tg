...
internal class TgRequestTest {
    ...
    private val messageId: Long = mockk()
...
//        val route = "route";
//
//        val req = CallbackRequest(user, route, emptyMap(), bot, chatId, messageId)
//
//        assertEquals(route, req.route)
//    }
